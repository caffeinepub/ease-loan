...
import type { ApplicationStatus as _ApplicationStatus, LoanApplication as _LoanApplication, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteLoanApplication(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteLoanApplication(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getApplicationsByStatus(arg0: ApplicationStatus): Promise<Array<LoanApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApplicationsByStatus(to_candid_ApplicationStatus_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLoanApplicationById(arg0: bigint): Promise<LoanApplication> {
        if (this.processError) {
            try {
                const result = await this.actor.getLoanApplicationById(arg0);
    ...
    async submitLoanApplication(arg0: string, arg1: string, arg2: number, arg3: string, arg4: string, arg5: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLoanApplication(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLoanApplication(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string, arg5: string, arg6: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLoanApplication(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
